...
function(copy_eden_Qt6_deps target_dir)
    ...
    if (MSVC)
        ...
        windows_copy_files(eden ${Qt6_PLATFORMS_DIR} ${PLATFORMS} qwindows$<$<CONFIG:Debug>:d>.*)
        windows_copy_files(eden ${Qt6_STYLES_DIR} ${STYLES} qwindowsvistastyle$<$<CONFIG:Debug>:d>.*)
        windows_copy_files(eden ${Qt6_IMAGEFORMATS_DIR} ${IMAGEFORMATS}
...
endfunction(copy_eden_Qt6_deps)
