...
class AlignmentMatchingStorage : public IStorage {
    EDEN_NON_COPYABLE(AlignmentMatchingStorage);
    EDEN_NON_MOVEABLE(AlignmentMatchingStorage);
...
class AlignmentMatchingStoragePooledBuffer : public IStorage {
    EDEN_NON_COPYABLE(AlignmentMatchingStoragePooledBuffer);
    EDEN_NON_MOVEABLE(AlignmentMatchingStoragePooledBuffer);
