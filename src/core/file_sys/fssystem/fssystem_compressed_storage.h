...
class CompressedStorage : public IReadOnlyStorage {
    EDEN_NON_COPYABLE(CompressedStorage);
    EDEN_NON_MOVEABLE(CompressedStorage);
...
private:
    class CompressedStorageCore {
        EDEN_NON_COPYABLE(CompressedStorageCore);
        EDEN_NON_MOVEABLE(CompressedStorageCore);
    ...
    class CacheManager {
        EDEN_NON_COPYABLE(CacheManager);
        EDEN_NON_MOVEABLE(CacheManager);
