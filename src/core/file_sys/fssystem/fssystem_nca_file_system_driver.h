...
class NcaReader {
    EDEN_NON_COPYABLE(NcaReader);
    EDEN_NON_MOVEABLE(NcaReader);
...
class NcaFsHeaderReader {
    EDEN_NON_COPYABLE(NcaFsHeaderReader);
    EDEN_NON_MOVEABLE(NcaFsHeaderReader);
...
class NcaFileSystemDriver {
    EDEN_NON_COPYABLE(NcaFileSystemDriver);
    EDEN_NON_MOVEABLE(NcaFileSystemDriver);
