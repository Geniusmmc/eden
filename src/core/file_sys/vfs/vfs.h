...
class VfsFilesystem {
public:
    EDEN_NON_COPYABLE(VfsFilesystem);
    EDEN_NON_MOVEABLE(VfsFilesystem);
...
class VfsFile {
public:
    EDEN_NON_COPYABLE(VfsFile);
    EDEN_NON_MOVEABLE(VfsFile);
...
class VfsDirectory {
public:
    EDEN_NON_COPYABLE(VfsDirectory);
    EDEN_NON_MOVEABLE(VfsDirectory);
