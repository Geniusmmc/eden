...
public:
    EDEN_NON_COPYABLE(KMemoryRegion);
    EDEN_NON_MOVEABLE(KMemoryRegion);
...
public:
    EDEN_NON_COPYABLE(KMemoryRegionTree);
    EDEN_NON_MOVEABLE(KMemoryRegionTree);
...
public:
    EDEN_NON_COPYABLE(KMemoryRegionAllocator);
    EDEN_NON_MOVEABLE(KMemoryRegionAllocator);
