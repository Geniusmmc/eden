...
class Packet {
public:
    EDEN_NON_COPYABLE(Packet);
    EDEN_NON_MOVEABLE(Packet);
...
class Frame {
public:
    EDEN_NON_COPYABLE(Frame);
    EDEN_NON_MOVEABLE(Frame);
...
class Decoder {
public:
    EDEN_NON_COPYABLE(Decoder);
    EDEN_NON_MOVEABLE(Decoder);
...
class HardwareContext {
public:
    EDEN_NON_COPYABLE(HardwareContext);
    EDEN_NON_MOVEABLE(HardwareContext);
...
class DecoderContext {
public:
    EDEN_NON_COPYABLE(DecoderContext);
    EDEN_NON_MOVEABLE(DecoderContext);
...
class DecodeApi {
public:
    EDEN_NON_COPYABLE(DecodeApi);
    EDEN_NON_MOVEABLE(DecodeApi);
