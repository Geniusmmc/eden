...
public:
    EDEN_NON_COPYABLE(OGLRenderbuffer);
...
public:
    EDEN_NON_COPYABLE(OGLTextureView);
...
public:
    EDEN_NON_COPYABLE(OGLAssemblyProgram);
...
public:
    EDEN_NON_COPYABLE(OGLFramebuffer);
...
public:
    EDEN_NON_COPYABLE(OGLTransformFeedback);
